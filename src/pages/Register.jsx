        ...
        <div className='bg-card/60 border border-border/30 p-8 rounded-3xl shadow-md shadow-black '>
            ...
            <form className='space-y-4'>
                <div className="relative">
                    ...
                    className=" pl-10 rounded-xl border border-border/40 bg-white/5 w-full py-3 text-sm outline-primary" 
                    autocomplete="email" 
                    value="">
                ...
                <p className='text-center text-white/30 text-sm font-body mt-6'>
                    ...
                    <NavLink className="text-primary hover:text-buttonHover font-semibold transition-colors" to="/login"> Sign in</NavLink>
                </p>
            </form>
        </div>
    )
