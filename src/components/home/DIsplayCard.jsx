...
const DIsplayCard = ({card}) => {
    ...
    return (
        <div className="bg-[#111] border border-white/80 rounded-3xl p-6 flex items-start gap-4">
            <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 ${card.iconStyle}`}>
                {card.svg}
            </div>
            <div>
                <p className="font-heading font-bold text-2xl text-white">{card.heroText}</p>
